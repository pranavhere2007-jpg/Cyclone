  ...
  return (
    ...
    >
      <div className="card-header">
        <div>
          <h3 className="card-title">{cyclone.cyclone_name || "Unnamed System"}</h3>
      ...
      <div style={{ marginTop: '1rem' }}>
        <div className="telemetry-row">
          ...
          <span className="telemetry-value danger">
            {cyclone.wind_speed ? `${cyclone.wind_speed} ${cyclone.wind_speed_unit}` : 'Calculating...'}
          </span>
        </div>
        <div className="telemetry-row">
          <span className="telemetry-label">Central Pressure:</span>
          <span className="telemetry-value">
            {cyclone.pressure ? `${cyclone.pressure} ${cyclone.pressure_unit}` : 'Calculating...'}
          </span>
        </div>
      </div>
