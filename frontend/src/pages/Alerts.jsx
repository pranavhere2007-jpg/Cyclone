    ...
    <div className="card">
      ...
      <div className="table-container">
        <table className="comparison-table">
          ...
          <tbody>
            {locations.map((loc) => (
              <tr key={loc.name || loc.location}>
                <td><strong>{loc.name || loc.location || 'Unknown'}</strong></td>
                <td>{loc.basin || 'Bay of Bengal'}</td>
                <td>
                ...
                <td>
                  {loc.alert_details ? (
                    <span>
                      <strong>{loc.alert_details.cyclone_name}</strong> — {loc.alert_details.status}
                    </span>
                  ) : (
